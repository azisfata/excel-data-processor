...
const LoginPage: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-indigo-900 via-blue-800 to-blue-900 flex items-center justify-center p-4 relative overflow-hidden">
      ...
      <div className="absolute bottom-20 right-20 w-64 h-64 bg-indigo-500 rounded-full mix-blend-multiply filter blur-xl opacity-20 animate-pulse" style={{ animationDelay: '2s' }}></div>
      <div className="absolute top-1/2 left-1/3 w-64 h-64 bg-purple-500 rounded-full mix-blend-multiply filter blur-xl opacity-20 animate-pulse" style={{ animationDelay: '4s' }}></div>
          ...
          <div className="mb-8">
            <div className="flex items-center justify-center lg:justify-start mb-6">
              <div className="relative flex h-16 w-16 items-center justify-center rounded-full bg-white/20 backdrop-blur-sm border border-white/30 transition-all duration-300 hover:scale-110 hover:bg-white/30">
                ...
                <svg xmlns="http://www.w3.org/2000/svg" className="relative h-8 w-8 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
          ...
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div className="bg-white/10 backdrop-blur-sm rounded-lg p-4 border border-white/20 transition-all duration-300 hover:bg-white/20 hover:scale-105 hover:shadow-xl cursor-pointer group">
                ...
                <p className="text-sm text-blue-100">Pemrosesan file Excel realisasi anggaran SAKTI otomatis</p>
              </div>
              ...
              <div className="bg-white/10 backdrop-blur-sm rounded-lg p-4 border border-white/20 transition-all duration-300 hover:bg-white/20 hover:scale-105 hover:shadow-xl cursor-pointer group">
                ...
                <p className="text-sm text-blue-100">Analisis data anggaran dengan kecerdasan buatan</p>
              </div>
              ...
              <div className="bg-white/10 backdrop-blur-sm rounded-lg p-4 border border-white/20 transition-all duration-300 hover:bg-white/20 hover:scale-105 hover:shadow-xl cursor-pointer group">
                ...
                <p className="text-sm text-blue-100">Dashboard interaktif untuk monitoring real-time</p>
              </div>
              ...
              <div className="bg-white/10 backdrop-blur-sm rounded-lg p-4 border border-white/20 transition-all duration-300 hover:bg-white/20 hover:scale-105 hover:shadow-xl cursor-pointer group">
                ...
                <p className="text-sm text-blue-100">Manajemen kegiatan dan alokasi anggaran terpadu</p>
              </div>
          ...
          <div className="bg-white/95 backdrop-blur-sm rounded-2xl shadow-2xl p-8 border border-white/20 transform transition-all duration-500 hover:scale-[1.02]">
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              <div>
                ...
                <p className="mt-1 text-xs text-gray-500">Hanya email institusi Kemenko PMK yang dapat digunakan</p>
              </div>
